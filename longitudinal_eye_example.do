...
* stset surv_age, failure(anydem) origin(time 0) enter(age_bl) id(subj) // unweighted
stset surv_age [pweight=wsiowbase], failure(anydem) origin(time 0) enter(age_bl) id(subj) // weighted
